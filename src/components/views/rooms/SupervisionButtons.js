...
export default class SupervisionButtons extends React.Component {

    constructor(props) {
        super(props);
        this._onInformMessageClicked = this._onInformMessageClicked.bind(this);
    ...
    _onInformMessageClicked(message) {
    ...
    _getButtonsContent() {
        return (<div>
                    <span className="mx_PredefinedMessages_SupervisionButton mx_SupervisionButton_1" onClick={() => this._onInformMessageClicked(_t("Going out of substation"))}>{_t("Going out of substation")}</span>
                    <span className="mx_PredefinedMessages_SupervisionButton mx_SupervisionButton_2" onClick={() => this._onInformMessageClicked(_t("Arriving in substation"))}>{_t("Arriving in substation")}</span>
                    <span className="mx_PredefinedMessages_SupervisionButton mx_SupervisionButton_3" onClick={() => this._onInformMessageClicked(_t("It's supervision okay?"))}>{_t("It's supervision okay?")}</span>
                </div>);
    }
